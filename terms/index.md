...
- Optional sync and backup features (for eligible plans and device capabilities)
...
- Some internal/admin features may require account-based authentication
- If you use an authenticated admin account, you are responsible for your credentials and activity under that account
- We may suspend or terminate authenticated access for violations of these Terms
...
- HealthKit integration requires your explicit consent
- We are not liable for injuries or health issues resulting from use of the App
...
- You retain ownership of workout data and personal information you provide
...
- By default, your workout data is stored on your device
- If enabled and available, data may be synchronized using iCloud and/or other configured services
- Sync features may require an active premium plan and compatible device/account settings
- You are responsible for enabling platform-level services (such as iCloud) if you want cloud backup
...
- We do not guarantee the accuracy or reliability of all features
- We are not responsible for fitness results or health outcomes

### Limitation of Liability

- Our liability is limited to the maximum extent permitted by law
- We are not liable for indirect, incidental, or consequential damages
- Your exclusive remedy is to stop using the App
...
We may suspend or terminate your access to authenticated/admin features immediately, without prior notice or liability, for any reason, including breach of these Terms.
